            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col"><a href="add" data-toggle="modal" data-target="#addCourseModal"><button class="btn btn-primary" style="float: right;">Add new Course</button></a><br></div>
                    </div>
                                ...
                                <table class="table dataTable my-0" id="dataTable2">
                                    ...
                                    @foreach($courses as $course)
                                        <tr>
                                            ...
                                            <td class="text-center"><a href={{"delete/".$course['id']}}><i class="fa fa-remove" style="color: rgb(255,0,0);font-size: 30px;"></i></a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
    ...
    <div class="modal-content" style="border-radius:21px;">
      ...
      <div class="modal-body">
        ...
        <form action="save" method="post"  enctype="multipart/form-data" id="addCourse">
            ...
            <div class="form-group">
                <input class="form-control" type="text" name="price" placeholder="Course Price">
